-- Trigger: genera/actualitza post "Noves entrades" al changelog quan s'afegeix un bookmark
...
CREATE TRIGGER trg_auto_post_new_bookmark
  AFTER INSERT ON public.bookmarks
  FOR EACH ROW EXECUTE FUNCTION public.auto_post_new_bookmark();
